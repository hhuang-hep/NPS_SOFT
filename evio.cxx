 ...
 * Revision History:
 *   $Log: evio.cxx,v $
 *   Revision 1.1.1.1  2010/07/12 19:42:04  jroche
 *   DVCS software for version 2 of the DVCS experiment. Initial upload. 
 *   This piece of software is a significant modification of /dvcs/soft used for the version 1 of the DVCS experiments (2005).
 *   This piece of code was written by Carlos Munoz.
 *
 *
 *   Revision 1.2  2004/09/28 03:52:20  munoz
 *   Counting house version
 *
 *   Revision 1.1  2004/05/20 19:31:18  camsonne
 *   decoding file
 *
 *   Revision 1.1  2003/10/01 06:46:59  camsonne
 *    adapted hana_decode_2.1 for stand alone version
 *
 ...
 *	  add evnum to EVFILE structure. Keep event number when call 
 *
