...
TFile tf("treewallanalyzed2.root","RECREATE");
...
// c->Print("allnoise.ps(");
 c2->Print("allnoise.ps(");
 c3->Print("allnoise.ps");
 c4->Print("allnoise.ps");
 c5->Print("allnoise.ps");
 c6->Print("allnoise.ps");
 c7->Print("allnoise.ps");
 c8->Print("allnoise.ps");
